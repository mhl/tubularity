...
public:
  ...
  itkTypeMacro(MultiScaleHessianBasedMeasureImageFilter2, 
                 ImageToImageFilter);
...
private:
  ...
  unsigned int																		m_NumberOfSigmaSteps;
	...
	bool																						m_UseAFixedSigmaForComputingHessianImage;
...
#include "itkMultiScaleHessianBasedMeasureImageFilter2.txx"
#endif
