/*=========================================================================
  ...
  Module:    $RCSfile: itkFastMarchingUpwindGradientImageFilter2.h,v $
  Language:  C++
...
#ifndef __itkFastMarchingUpwindGradientImageFilter2_h
#define __itkFastMarchingUpwindGradientImageFilter2_h
...
namespace itk
{
/** \class FastMarchingUpwindGradientImageFilter2
 *
...
template <
  class TLevelSet, 
  class TSpeedImage = Image<double,::itk::GetImageDimension<TLevelSet>::ImageDimension> >
class ITK_EXPORT FastMarchingUpwindGradientImageFilter2 :
    public FastMarchingImageFilter2<TLevelSet,TSpeedImage>
{

public:
  /** Standard class typdedefs. */
  typedef FastMarchingUpwindGradientImageFilter2          Self;
  typedef FastMarchingImageFilter2<TLevelSet,TSpeedImage> Superclass;
  ...
  itkTypeMacro(FastMarchingUpwindGradientImageFilter2, FastMarchingImageFilter2);
...
private:
  FastMarchingUpwindGradientImageFilter2(const Self&); //purposely not implemented
...
#include "itkFastMarchingUpwindGradientImageFilter2.txx"
#endif
