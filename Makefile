...
CLASSPATH=.:ij.jar:/home/fbenmans/Downloads/Fiji.app/plugins/3D_Viewer.jar:/home/fbenmans/Downloads/Fiji.app/java/linux-amd64/jdk1.6.0_24/jre/lib/ext/j3dutils.jar:/home/fbenmans/Downloads/Fiji.app/java/linux-amd64/jdk1.6.0_24/jre/lib/ext/j3dcore.jar:/home/fbenmans/Downloads/Fiji.app/java/linux-amd64/jdk1.6.0_24/jre/lib/ext/vecmath.jar

# /localhome/fbenmans/InsightToolkit-3.20.0/
...
plugins/MultiScaleTubularityMeasure_Plugin.jar : FijiITKInterface/MultiScaleTubularityMeasure.class FijiITKInterface/MultiScaleTubularityMeasure_Plugin.class plugins.config fiji/jni/LibraryLoader.class build/$(ARCH)/libMultiScaleTubularityMeasure.$(LIBRARY_EXTENSION) # build/macosx/libMultiScaleTubularityMeasure.dylib 
	mkdir -p plugins
	jar cvf plugins/MultiScaleTubularityMeasure_Plugin.jar FijiITKInterface/MultiScaleTubularityMeasure.class FijiITKInterface/MultiScaleTubularityMeasure_Plugin.class plugins.config fiji/jni/LibraryLoader.class -C build $(ARCH)/libMultiScaleTubularityMeasure.$(LIBRARY_EXTENSION) # build/macosx/libMultiScaleTubularityMeasure.dylib
