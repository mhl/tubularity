/*=========================================================================
  ...
  Module:    $RCSfile: itkFastMarchingImageFilter2.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkFastMarchingImageFilter2_h
#define __itkFastMarchingImageFilter2_h
...
/** \class FastMarchingImageFilter2
 ...
 * FastMarchingImageFilter2 is used in the ReinitializeLevelSetImageFilter
...
class ITK_EXPORT FastMarchingImageFilter2 :
    public ImageToImageFilter<TSpeedImage,TLevelSet>
{
public:
  /** Standard class typdedefs. */
  typedef FastMarchingImageFilter2   Self;
  ...
  itkTypeMacro(FastMarchingImageFilter2, ImageSource);
  ...
  itkBooleanMacro( OverrideOutputInformation );
	itkSetMacro( ScaleSpeedFactor, double );
	itkGetMacro( ScaleSpeedFactor, double );
...
private:
  FastMarchingImageFilter2(const Self&); //purposely not implemented
...
#include "itkFastMarchingImageFilter2.txx"
#endif
