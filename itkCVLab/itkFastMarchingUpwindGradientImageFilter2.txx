/*=========================================================================
  ...
  Module:    $RCSfile: itkFastMarchingUpwindGradientImageFilter2.txx,v $
  Language:  C++
...
#ifndef __itkFastMarchingUpwindGradientImageFilter2_txx
#define __itkFastMarchingUpwindGradientImageFilter2_txx
...
FastMarchingUpwindGradientImageFilter2<TLevelSet,TSpeedImage>
::FastMarchingUpwindGradientImageFilter2()
{
  m_TargetPoints = NULL;
  ...
  GradientImageType * gradientImage)
{
  ...
  for ( unsigned int j = 0; j < SetDimension; j++ )
    ...
    gradientPixel[j] /= spacing[j];
			if(j == SetDimension-1)			gradientPixel[j] *= Superclass::GetScaleSpeedFactor();
    }
