/*=========================================================================
 ...
 Module:    $RCSfile: itkFastMarchingImageFilter2.txx,v $
 Language:  C++
 ...
 =========================================================================*/
#ifndef __itkFastMarchingImageFilter2_txx
#define __itkFastMarchingImageFilter2_txx

#include "itkFastMarchingImageFilter2.h"
...
namespace itk
{
	...
	FastMarchingImageFilter2<TLevelSet,TSpeedImage>
								   ...
								   DataObject *output )
	{
		...
		else
		{
			...
			itkWarningMacro(<< "itk::FastMarchingImageFilter2" <<
				  ...
				  LevelSetImageType * output )
	{
		...
		for ( unsigned int j = 0; j < SetDimension; j++ )
		{
			...
			if ( solution >= node.GetValue() )
			{
				...
				double spaceFactor = vnl_math_sqr( 1.0 / spacing[axis] );
				
				if( axis == SetDimension-1 )
					spaceFactor *= vnl_math_sqr(m_ScaleSpeedFactor);
