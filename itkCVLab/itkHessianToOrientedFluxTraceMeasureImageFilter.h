...
#ifndef __itkHessianToOrientedFluxTraceMeasureFilter_h
#define __itkHessianToOrientedFluxTraceMeasureFilter_h
...
namespace itk
{
	...
	/** \class HessianToOrientedFluxTraceMeasureFilter
	 * \brief This filter takes as input a hessian of an image
	 * and convolve it with the oriented flux kernel and outputs the trace.
	...
	class ITK_EXPORT HessianToOrientedFluxTraceMeasureFilter:
	public ImageToImageFilter<TInputImage,TOutputImage>
	{
	public:
		/** Standard class typedefs. */
		typedef HessianToOrientedFluxTraceMeasureFilter												Self;
    ...
    typedef typename OutputImageType::RegionType              OutputImageRegionType;
		...
		itkTypeMacro( HessianToOrientedFluxTraceMeasureFilter, ImageToImageFilter );
		...
		/** HessianToOrientedFluxTraceMeasureFilter needs all of the input to produce an
		 * output. Therefore, HessianToOrientedFluxTraceMeasureFilter needs to provide
	...
	protected:
		...
		virtual ~HessianToOrientedFluxTraceMeasureFilter() {};
	...
	private:
		...
		HessianToOrientedFluxTraceMeasureFilter(const Self&); //purposely not implemented
...
#include "itkHessianToOrientedFluxTraceMeasureImageFilter.txx"
#endif
