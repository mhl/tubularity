...
#ifndef __itkTubularMetricToPathFilter2_txx
#define __itkTubularMetricToPathFilter2_txx

#include "itkTubularMetricToPathFilter2.h"

namespace itk
{
	
	template <class TInputImage, class TOutputPath>
	TubularMetricToPathFilter2<TInputImage,TOutputPath>
	::TubularMetricToPathFilter2()
	{
		m_TerminationDistanceFactor = 1.0;
		m_DescentStepFactor					= 1.0;
	 ...
	 */
	template<class TInputImage, class TOutputPath>
	const typename TubularMetricToPathFilter2<TInputImage,TOutputPath>::IndexType &
	TubularMetricToPathFilter2<TInputImage,TOutputPath>
								 ...
								 std::vector<double>& outputDistanceList)
	{
		...
		charPathFilter->SetInput( distImage );
