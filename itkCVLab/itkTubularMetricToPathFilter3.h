...
#ifndef __itkTubularMetricToPathFilter3_h
#define __itkTubularMetricToPathFilter3_h
...
namespace itk
{
	...
	/** \class TubularMetricToPathFilter3
	 *
	...
	class ITK_EXPORT TubularMetricToPathFilter3 :
	public ImageToPathFilter< TInputImage, TOutputPath >
	{
	public:
		/** Standard class typedefs. */
		typedef TubularMetricToPathFilter3                Self;
		typedef ImageToPathFilter<TInputImage,TOutputPath>					Superclass;
		typedef SmartPointer<Self>																	Pointer;
		typedef SmartPointer<const Self>														ConstPointer;
		
		/** Run-time type information (and related methods). */
		itkTypeMacro( TubularMetricToPathFilter3, ImageToPathFilter );
	...
	private:
		TubularMetricToPathFilter3(const Self&); //purposely not implemented
...
#include "itkTubularMetricToPathFilter3.txx"
